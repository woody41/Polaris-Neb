...
/mob/living/simple_mob
	name = "animal"
	desc = ""
	icon = 'maps/cynosure/icons/mob/animal.dmi'
	current_health = 20
	max_health = 20
	...
	var/has_langs = list("Galactic Common")// Text name of their language if they speak something other than galcom. They speak the first one.
...
/mob/living/simple_mob/Initialize()
	//verbs -= /mob/verb/observe //TODO Define this
	current_health = max_health

	for(var/L in has_langs)
		//languages |= GLOB.all_languages[L] //TODO add languages. I can;t find out how Nebula manage all the languages
	if(languages.len)
...
/mob/living/simple_mob/set_dir(new_dir)
	...
	return ..()
*/
//TODO fix this following move delay
/*
...
/mob/living/simple_mob/Stat()
	...
	if(statpanel("Status") && show_stat_health)
		stat("Health:", "[round((current_health / get_max_health()) * 100)]%")
...
/mob/living/simple_mob/say_quote(verb, var/ending)
	return verb
...
/mob/living/simple_mob/mob_sleep()
	if(player_triggered_sleeping || stat != CONSCIOUS)
		tranq_countdown = null
		tranq_duration = null
		//TODO fix sleeping time
		/*
